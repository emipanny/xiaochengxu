...
Page({
  ...
  init: function (id) {
    ...
    let url = "https://xcx.envisioneer.cn/boss/getPreview";
    let data = { id };
            ...
            while (time < end - 86400) {
              ...
              for (let j = 0; j < quota.length; j++) {
                ...
                if (start_time <= time && time + 86400 <= end_time) {
                  ...
                  stage[len].date[h].quota[quota_len].state = quota[j].state;
                }
              }
              for (let j = 0; j < material.length; j++) {
                ...
                if (time <= rTime && rTime < time + 86400) {
                  ...
                  stage[len].date[h].material[material_len].state = material[j].state;
                }
              }
            }
          }
